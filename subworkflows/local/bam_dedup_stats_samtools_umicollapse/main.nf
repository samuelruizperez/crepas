...
workflow BAM_DEDUP_STATS_SAMTOOLS_UMICOLLAPSE {
    ...
    if (!skip_split_by_chrom) {
        ...
        ch_bam_index_chroms
            ...
            .collectFile( name: 'ch_bam_index_chroms.txt', newLine: true, sort: false, storeDir: "${params.outdir}/.debug/BAM_DEDUP_STATS_SAMTOOLS_UMICOLLAPSE" )
