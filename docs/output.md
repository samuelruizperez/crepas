...
| CISRPM-SOI | **CISRPM** **S**ignal (ChIP) **O**ver **I**nput | Per bin: $$\alpha_{\text{CISRPM-SOI}} = \begin{cases} 0, & \text{if } \alpha_{\text{CISRPM input}} = 0 \\ \frac{\alpha_{\text{CISRPM ChIP}}}{\alpha_{\text{CISRPM input}}}, & \text{otherwise} \end{cases}$$ | $$\alpha_{\text{CISRPM-SOI}}$$ | - |
