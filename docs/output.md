...
| CISRPM-SOI | **CISRPM** **S**ignal (ChIP) **O**ver **I**nput | Per bin: <br> ![formula](https://render.githubusercontent.com/render/math?math=\alpha_{\text{CISRPM-SOI}}%20=%20\begin{cases}%200,%20%26%20\text{if%20}%20\alpha_{\text{CISRPM%20input}}%20=%200%20\\%20\frac{\alpha_{\text{CISRPM%20ChIP}}}{\alpha_{\text{CISRPM%20input}}},%20%26%20\text{otherwise}%20\end{cases}) | $$\alpha_{\text{CISRPM-SOI}}$$ | - |
