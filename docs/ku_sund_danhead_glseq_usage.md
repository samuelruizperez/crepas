...
> [!IMPORTANT]
> Please read this documentation on the grothlab/glseq repository: [https://github.com/grothlab/glseq/blob/dev/docs/ku_dan_glseq_usage.md](https://github.com/grothlab/glseq/blob/dev/docs/ku_dan_glseq_usage.md)
