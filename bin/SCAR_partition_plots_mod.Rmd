...
opt_scarminusinput_partition_file <- c(
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_714_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv",
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_724_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv",
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_MUT26_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv",
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_MUT43_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv",
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_MUT45_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv",
  "/home/whq695/datadir/projects/glseq_runs/SJC013_forward/output/chromap/mergedLibrary/scarseq/6_partitions/scarseq_MUT74_ChIP_REP1.mLb.dedup.flT1.GRCm39.flT2.flT3.rpm.smi.partition.w1000.s30.d30.z1.tsv"
  
)

opt_strandedinput_partition_file <- NULL

opt_okazaki_file <- "/home/whq695/datadir/projects/glseq_runs/SJC013_old2/partition_plots/896b4cf20a63da6582a31906c071f2/OKseq_RFD_mESC_SRR7535256_r1_R1.csorted.nodup.GRCm39_SE_smooth_results_w1000_s30_d30_z1.bed.gz"

opt_initiation_zones <- "/home/whq695/Groth_group/shared/references/Mus_musculus/GRCm39/external_data/Replication/Okazaki_seq/bed_files/OKseq_Initiation_Zones_mESC_SRR7535256_r1_R1.csorted.nodup.GRCm38liftOver.GRCm39_SE_smooth_results_w1000_s30_d30_z1.bed.gz"

opt_blacklist <- "/home/whq695/datadir/projects/glseq_runs/SJC013_old2/partition_plots/896b4cf20a63da6582a31906c071f2/GRCm39.ExcludeRanges.Boyle.Excludable_v2.bed"

opt_prefix <- "SCJ013_714_724_MUT26_MUT43_MUT45_MUT74"

opt_outdir <- "/home/whq695/datadir/projects/glseq_runs/SJC013_old2/partition_plots"
...
for (type in names(part_files)) {
  ...
  for (file in part_files[[type]]) {
    ...
    if (HAS_OKSEQ) {
      ...
      IZ_df <- read_tsv(opt_initiation_zones, col_select = c(1:3), col_names = c("seqnames","start","end"))
