...
for (type in names(part_files)) {
  ...
  message("[", Sys.time(), "] Processing partition type: ", type)
  ...
  for (file in part_files[[type]]) {
    ...
    if (HAS_OKSEQ) {
      ...
      if (OK_BIN_SIZE != PART_BIN_SIZE) {
        stop("[", Sys.time(), "] ERROR: Bin size of", base_name, "(", PART_BIN_SIZE, "bp ) is not the same bin size as in the provided OK-seq partition file (", OK_BIN_SIZE, "bp ).")
      }
      ...
      message("[", Sys.time(), "] Loading initiation zones from file: ", opt_initiation_zones)
    ...
    message("[", Sys.time(), "] Number of initiation zones: ", n.izs)
...
# Final processing of RFD_mean_df
