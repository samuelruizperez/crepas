...
**grothlab/crepas** is a bioinformatics pipeline that ...
...
grothlab/crepas was originally written by Samuel Ruiz-Pérez, Qian Du, Alva Biran, Anja Groth, Nicolas Alcaraz.
...
<!-- If you use grothlab/crepas for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
