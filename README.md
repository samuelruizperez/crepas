...
**grothlab/glseq** is a bioinformatics pipeline that ...
...
grothlab/glseq was originally written by Samuel Ruiz-Pérez.
...
<!-- If you use grothlab/glseq for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
