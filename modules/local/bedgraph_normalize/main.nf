process BEDGRAPH_NORMALIZE {
    ...
    awk \\
        ...
        'BEGIN{OFS="\\t"}{ \\
        if (operation == "multiply") {print \$1, \$2, \$3, \$4*norm_factor} \\
        else if (operation == "divide") {print \$1, \$2, \$3, \$4/norm_factor} \\
        else if (operation == "add") {print \$1, \$2, \$3, \$4+norm_factor} \\
        else if (operation == "subtract") {print \$1, \$2, \$3, \$4-norm_factor}}' \\
        $bdg \\
        > ${prefix}.bedgraph
